...
<form action="${pageContext.request.contextPath }/user/userregister.do" method="post">
      	  ...
      	  用&nbsp;户&nbsp;&nbsp;名：<input type="text"   name="username" id="username" class="list-input"/>
        <br>
       	登录密码： <input type="password"  name="password" id="Userpassword" class="list-input"/>
       <br>
     	  中文姓名：<input type="text" name="name" id="Username"/>
     	 <br>
